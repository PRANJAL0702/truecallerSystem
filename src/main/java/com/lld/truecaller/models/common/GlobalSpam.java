...
import static com.lld.truecaller.models.common.Constants.MAX_COUNT_TO_MARK_GLOBAL_BLOCKED;
import static com.lld.truecaller.models.common.Constants.MAX_GLOBAL_SPAM_COUNT;
...
public class GlobalSpam {
    ...
    public boolean isGlobalBlocked(String number) {
